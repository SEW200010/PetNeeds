...
import { User, Calendar as CalendarIcon, Settings, Bell, LogOut, ChevronRight } from "lucide-react";
  ...
  useEffect(() => {
    ...
    try {
      ...
      axios
        ...
        .then((res) => setUser({ fullName: res.data.fullName, email: res.data.email }))
