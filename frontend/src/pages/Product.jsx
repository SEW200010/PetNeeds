            ...
            <div>
                {Object.keys(groupedProducts).map((category) => (
                  <div key={category} className="mb-12">
                    <h2 className="text-2xl font-semibold mb-6">{category} Products</h2>
                    <div className="grid lg:grid-cols-6 gap-6 w-[1500px] h-[400px]">
                      {groupedProducts[category].map((product) => (
                        <div
                                key={product.id}
                                className="bg-white rounded-2xl shadow-md overflow-hidden flex flex-col items-center"
                              >
                                <img
                                  src={product.image}
                                  alt={product.name}
                                ...
                                <div className="p-4 flex flex-col gap-2 ">
                                  ...
                                  <button
                                    ...
                                    className="mt-3 w-[150px] h-[40px] rounded-xl text-white font-medium
                                    bg-gradient-to-r from-pink-500 to-purple-600 hover:scale-110 self-center"
                                  >
                                    Quick Add
                                  </button>
                                </div>
