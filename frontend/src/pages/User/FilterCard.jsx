...
const FilterCard = ({ search, setSearch, petType, setPetType, price, setPrice }) => {
  ...
  return (
    <div className="sticky top-24 w-full max-w-sm md:max-w-md lg:max-w-lg xl:w-[550px] bg-black shadow-xl rounded-2xl p-4 md:p-6 lg:p-8 h-fit">
      <h2 className="text-2xl md:text-3xl font-semibold text-center text-white mb-4 md:mb-6">Filter</h2>
      ...
      <button
        ...
        className="w-full border border-gray-300 py-3 hover:scale-110  font-semibold text-white hover:bg-red-600"
      >
        Reset Filters
      </button>
    </div>
